from ccandle.config.config_db import TABLE_VECTORS
...
from ccandle.pages.types.extract_type_signals import *
from ccandle.pages.types.type_signals_scaler import scale_signal_vectors
from ccandle.pages.types.type_signals_defs import SIGNAL_KEYS, SIGNALS_VECTOR_DIM, THRESH_PAGE_EMPTY
...
def decompose_page(page_id, verbose=False):
    ...
    child_count = len(json.loads(child_list)) if child_list else 0
