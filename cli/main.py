...
from cli.commands import connection, spaces, labels, sync, smoke_test, stats

COMMANDS = [connection, spaces, labels, sync, smoke_test, stats]  # just add new modules here as you grow
