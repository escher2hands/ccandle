...
from cli.commands import connection, spaces, labels, sync, smoke_test, sql

COMMANDS = [connection, spaces, labels, sync, sql, smoke_test]  # just add new modules here as you grow
