...
def extract_prose_paragraphs(soup):
    ...
    def process_children(children):
        """Walk a flat list of siblings and return word counts with list rollup."""
        results = []
        i = 0
        while i < len(children):
            ...
            if tag.name == "p":
                ...
                # roll up immediately following lists
                j = i + 1
    ...
    # If the page uses ac:layout, process each layout-cell independently.
    # Otherwise fall back to processing the root's direct children.
